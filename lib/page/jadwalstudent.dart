...
class jadwalstudent extends StatefulWidget {
  const jadwalstudent({Key? key}) : super(key: key);

  @override
  State<jadwalstudent> createState() => _jadwalstudentState();
}

class _jadwalstudentState extends State<jadwalstudent> {
